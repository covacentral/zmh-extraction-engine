    ...
    >
      ...
      <div className="w-full max-w-sm flex-col items-center flex gap-6 z-10">
        ...
        {(() => {
           ...
           const buttonContent = (
              <div 
                 className="w-full p-5 rounded-3xl font-black text-center shadow-[0_10px_30px_rgba(0,0,0,0.5)] border border-white/20 hover:scale-[1.02] active:scale-95 transition-all flex justify-between items-center group cursor-pointer"
              ...
              >
                 <div className="flex items-center gap-3" style={{ color: contrastColor }}>
                    ...
                    <span className="text-lg" style={{ color: contrastColor }}>{buttonText}</span>
                 </div>
