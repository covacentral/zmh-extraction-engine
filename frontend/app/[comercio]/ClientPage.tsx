      ...
      <div className="w-full max-w-sm flex-col items-center flex gap-6 z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="w-full mt-2">
           <Link href={`/${commerceId}/catalogo`}>
              <div className="w-full bg-[var(--theme)] text-white p-5 rounded-3xl font-black text-center shadow-[0_10px_30px_rgba(0,0,0,0.5)] border border-white/20 hover:scale-[1.02] active:scale-95 transition-all flex justify-between items-center group">
